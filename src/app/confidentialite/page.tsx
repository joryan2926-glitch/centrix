    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          items: ["Supabase pour auth, base de donnees et storage", "Vercel pour l'hebergement applicatif", "Stripe pour paiements et abonnements", "OpenAI pour les fonctions IA", "Resend, Google, Twilio, DocuSign ou Bridge selon configuration"]
        },
        {
