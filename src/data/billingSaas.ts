...
export const saasBillingFallbackData: SaaSBillingData = {
  plans: [
    ...
    { id: "plan-starter", code: "starter", name: "Starter", description: "Pour independants et petites equipes.", monthlyPrice: 29, yearlyPrice: 290, stripePriceId: "price_starter_demo", userLimit: 5, storageLimitGb: 20, modules: ["crm", "billing", "documents"], features: ["Facturation", "Documents", "5 utilisateurs"], highlighted: false },
    { id: "plan-premium", code: "premium", name: "Premium", description: "Pour equipes qui veulent automatiser leurs operations.", monthlyPrice: 79, yearlyPrice: 790, stripePriceId: "price_premium_demo", userLimit: 20, storageLimitGb: 100, modules: ["crm", "billing", "finance", "support", "documents"], features: ["Support prioritaire", "Finance", "Automatisations"], highlighted: true },
    { id: "plan-business", code: "business", name: "Business", description: "Pour PME multi-modules avec reporting avance.", monthlyPrice: 149, yearlyPrice: 1490, stripePriceId: "price_business_demo", userLimit: 60, storageLimitGb: 500, modules: ["crm", "billing", "finance", "hr", "marketing", "support", "documents", "ai"], features: ["IA Business", "RH", "Marketing", "60 utilisateurs"], highlighted: false },
    { id: "plan-enterprise", code: "enterprise", name: "Enterprise", description: "Pour groupes, franchises et besoins securite avances.", monthlyPrice: 499, yearlyPrice: 4990, stripePriceId: "price_enterprise_demo", userLimit: 500, storageLimitGb: 5000, modules: ["all"], features: ["SSO futur", "SLA dedie", "Multi-entreprises", "Quotas sur mesure"], highlighted: false }
  ],
  customers: [
