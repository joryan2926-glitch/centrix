...
export const operationalModules = {
  ...
  permissions: moduleConfig("permissions", "Permissions", "Administration", "Definissez et auditez les autorisations par profil et module.", "permission", ["Lecture", "Creation", "Modification", "Administration"], ["Verifier les droits sensibles", "Appliquer le moindre privilege", "Planifier une revue"]),
  users: moduleConfig("users", "Utilisateurs", "Administration", "Gerez les utilisateurs, invitations et statuts de l'entreprise.", "utilisateur", ["Responsable", "Collaborateur", "Utilisateur", "Client"], ["Traiter les invitations", "Verifier les comptes inactifs", "Mettre a jour les profils"]),
  roles: moduleConfig("roles", "Profils", "Administration", "Structurez les profils et responsabilites de l'organisation.", "profil", ["Direction", "Equipe", "Operation", "Externe"], ["Clarifier les responsabilites", "Verifier les permissions", "Archiver les profils inutilises"])
